...
This report is organized into five chapters detailing the progression of the work carried out during the internship. \textbf{Chapter 1} presents the general context of the internship and the host company. \textbf{Chapter 2} presents the state of the art, preliminary study, project specifications, and SLM-Evals motivation. \textbf{Chapter 3} presents the system design and architecture of the VIP platform. \textbf{Chapter 4} details the implementation, evaluation, and obtained results. \textbf{Chapter 5} concludes the report by summarizing the main contributions, identifying the current limitations, and proposing perspectives for future work.
